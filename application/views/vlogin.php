...
<head>
  ...
  <title>Salesforce | AJB Semarang Login</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>AJB Semarang</b> Login</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to start your session <br /> <?php $this->session->flashdata('pesanlogout'); ?></p>
