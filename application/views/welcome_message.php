    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('pesanan');?>"><i class="fa fa-circle-o"></i> Surat Pesanan</a></li>
             <li><a href="<?php echo base_url('sjalan');?>"><i class="fa fa-circle-o"></i> Surat Jalan</a></li>
          </ul>
        </li>
      </ul>
    </section>
...
<script type="text/javascript">
    $(document).ready(function(){
       ...
       $.ajax({
                type  : 'POST',
                url   : '<?php echo base_url("pesanan/gettotalsales");?>',
                async : false,
                dataType : 'json',
                success : function(data){
                     console.log(data[0].total);
                     document.getElementById('totalsales').innerHTML=data[0].total;
                }
 
            }); 
        $.ajax({
                type  : 'POST',
                url   : '<?php echo base_url("pesanan/gettotaljalan");?>',
                async : false,
                dataType : 'json',
                success : function(data){
                     console.log(data[0].total);
                     document.getElementById('totaljalan').innerHTML=data[0].total;
                }
 
            }); 
        $.ajax({
                type  : 'POST',
                url   : '<?php echo base_url("pesanan/gettotalpesanan");?>',
                async : false,
                dataType : 'json',
                success : function(data){
                     console.log(data[0].total);
                     document.getElementById('totalpesanan').innerHTML=data[0].total;
                }
